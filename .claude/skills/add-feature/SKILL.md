...
When adding a new feature we need a plan. The plan will be in the Plans directory. Prompt the user to select whcih plan they want to execure. Eneter plan mode, read the selected plan, use the `grill-me` skill to get all the information needed. Once everything has been confirmed:
