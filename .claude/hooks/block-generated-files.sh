...
case "$FILE_PATH" in
  ...
  bin/*|*/bin/*|obj/*|*/obj/*)
    REASON="Cannot write into .NET build output directories (bin/obj) — these are generated by dotnet build." ;;
  .angular/*|*/.angular/*)
    REASON="Cannot write into .angular/ — this is Angular CLI's cache directory." ;;
